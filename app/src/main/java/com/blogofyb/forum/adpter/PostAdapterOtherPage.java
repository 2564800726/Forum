...
public class PostAdapterOtherPage extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final int TYPE_TO_AUTHOR = 0;
    private final int TYPE_TO_ANOTHER = 1;
    ...
    public int getItemViewType(int position) {
        if (data.get(position).get(Keys.ANOTHER_USER_NAME) != null
                && !"".equals(data.get(position).get(Keys.ANOTHER_USER_NAME))) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
        if (i == TYPE_TO_ANOTHER) {
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.to_another, viewGroup, false);
            return new ToAnotherHolder(view);
        } else {
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.to_author, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof ToAnotherHolder) {
            PostAdapterOtherPage.ToAnotherHolder holder = (PostAdapterOtherPage.ToAnotherHolder) viewHolder;
            ...
            PostAdapterOtherPage.ToAuthorHolder holder = (PostAdapterOtherPage.ToAuthorHolder) viewHolder;
