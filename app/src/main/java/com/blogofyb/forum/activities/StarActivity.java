...
public class StarActivity extends BaseActivity {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                ...
                case GET_POST_FAILED:
                    mSwipeRefreshLayout.setRefreshing(false);
                    Toast.makeText(StarActivity.this, "加载失败", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        toolbar.setTitle(getResources().getString(R.string.star));
        toolbar.setTitleTextColor(getResources().getColor(R.color.colorWhite));
        toolbar.setNavigationIcon(R.drawable.back);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivitiesManager.removeActivity(StarActivity.this);
            }
        });
    ...
    private void loadBean() {
        ...
        Get.sendHttpRequest(ServerInformation.STAR + mAccount, new HttpCallbackListener() {
            @Override
