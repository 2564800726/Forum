...
public class FindPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Handler handler = new Handler() {
        private void showMessage(Message message) {
            Looper.prepare();
            Toast.makeText(FindPasswordActivity.this, message.getData().getString(Keys.MESSAGE), Toast.LENGTH_SHORT).show();
            Looper.loop();
        }
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case Messages.REGISTER_SUCCESS:
                    ...
                    Intent intent = new Intent(FindPasswordActivity.this, ForumActivity.class);
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivitiesManager.removeActivity(FindPasswordActivity.this);
            }
        });
    }
    ...
    private void findPassword() {
        ...
        Post.sendHttpRequest(ServerInformation.ADDRESS + "findPassword", body, new HttpCallbackListener() {
            @Override
            ...
            public void onFailure(Exception e) {
                ...
                Bundle bundle = new Bundle();
                message.what = Messages.REGISTER_FAILED;
                bundle.putString(Keys.MESSAGE, "找回密码失败");
                message.setData(bundle);
                handler.sendMessage(message);
            }
        });
    ...
    private void setButtonClickable(boolean value) {
        findPassword.setClickable(value);
    }
